...
public class Exercise23 extends BaseClass {
	...
	void verifyAddress() {
		...
		Assert.assertEquals(driver.findElement(By.xpath(
				"//ul[@id='address_delivery']//li[@class='address_address1 address_address2'][text()='Ahmedabad']"))
				.getText(), "Ahmedabad");
	}
	...
	void verifyBillingAddres() {
		...
		Assert.assertEquals(driver.findElement(By.xpath(
				"//ul[@id='address_invoice']//li[@class='address_address1 address_address2'][text()='Ahmedabad']"))
				.getText(), "Ahmedabad");
	}
